...
public class CorruptedFlintAndSteelItem  extends Item {
    public CorruptedFlintAndSteelItem(Settings settings) {
        super(settings);
    }
    ...
    public ActionResult useOnBlock(ItemUsageContext context) {
        ...
        if (CorruptedFireBlock.canPlaceAt(world, blockPos2, context.getHorizontalPlayerFacing())) {
            ...
            BlockState blockState2 = CorruptedFireBlock.getState(world, blockPos2);
